...
export const translations = {
  pt: {
    ...
    // Status checking
    checkAllStatuses: "Verificar Todos",
    checkAllStatusesDesc: "Verifica o status de todos os serviços visíveis",
    checkingAll: "Verificando todos...",
    checkedCount: "verificados",
    autoCheckEnabled: "Verificação automática ao carregar",
    autoCheckDisabled: "Verificação manual apenas",
    statusCheckingProgress: "Verificando",
    lastChecked: "Última verificação",
    neverChecked: "Nunca verificado",
    statusSourceLLM: "Análise por IA",
    statusSourceKeyword: "Análise por palavras-chave",
    statusSourceSearch: "Busca web",
    statusLegendTitle: "Legenda de Status",
    statusLegendOp: "Operacional — Serviço funcionando normalmente",
    statusLegendDeg: "Degradado — Lentidão, rate limiting ou problemas parciais",
    statusLegendOut: "Indisponível — Queda geral ou problemas graves",
    statusLegendUnk: "Desconhecido — Status ainda não verificado",
  ...
  en: {
    ...
    checkAllStatuses: "Check All",
    checkAllStatusesDesc: "Check the status of all visible services",
    checkingAll: "Checking all...",
    checkedCount: "checked",
    autoCheckEnabled: "Auto-check on load",
    autoCheckDisabled: "Manual check only",
    statusCheckingProgress: "Checking",
    lastChecked: "Last checked",
    neverChecked: "Never checked",
    statusSourceLLM: "AI Analysis",
    statusSourceKeyword: "Keyword Analysis",
    statusSourceSearch: "Web Search",
    statusLegendTitle: "Status Legend",
    statusLegendOp: "Operational — Service running normally",
    statusLegendDeg: "Degraded — Slow, rate limiting, or partial issues",
    statusLegendOut: "Outage — Major downtime or severe problems",
    statusLegendUnk: "Unknown — Status not yet checked",
  ...
  zh: {
    ...
    checkAllStatuses: "全部检查",
    checkAllStatusesDesc: "检查所有可见服务的状态",
    checkingAll: "正在检查全部...",
    checkedCount: "已检查",
    autoCheckEnabled: "加载时自动检查",
    autoCheckDisabled: "仅手动检查",
    statusCheckingProgress: "正在检查",
    lastChecked: "上次检查",
    neverChecked: "从未检查",
    statusSourceLLM: "AI分析",
    statusSourceKeyword: "关键词分析",
    statusSourceSearch: "网络搜索",
    statusLegendTitle: "状态图例",
    statusLegendOp: "正常运行 — 服务运行正常",
    statusLegendDeg: "性能下降 — 缓慢、限流或部分问题",
    statusLegendOut: "服务中断 — 重大停机或严重问题",
    statusLegendUnk: "未知 — 状态尚未检查",
